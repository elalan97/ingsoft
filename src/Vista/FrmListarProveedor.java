...
public class FrmListarProveedor extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmListarProveedor
     */
    ...
    public void listar(){
        ArrayList<Proveedor> lista = controlador.listarProveedor();
        
        DefaultTableModel modelo = (DefaultTableModel) tbProveedor.getModel();
        modelo.setRowCount(0);
        
        for (Proveedor proveedor : lista) {
            modelo.addRow(new Object[]{proveedor.getCedula(), proveedor.getNombre(), proveedor.getApellido(),
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        FrmProveedor evet = new FrmProveedor();

...
public class FrmListarCliente extends javax.swing.JFrame {
     ...
     */
    public void listar() {
        ArrayList<Cliente> lista = controlador.listarCliente();

        DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
        modelo.setRowCount(0);

        for (Cliente cliente : lista) {
            modelo.addRow(new Object[]{cliente.getCedula(), cliente.getNombre(), cliente.getApellido(),
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        FrmCliente event = new FrmCliente();
